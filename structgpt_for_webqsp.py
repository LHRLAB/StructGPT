...
def parse_args():
    ...
    parser.add_argument('--input_path', default="./data/webqsp/webqsp_simple_test.jsonl")
    parser.add_argument('--output_path', default="./outputs/webqsp/output_wo_icl_v1.jsonl")
    parser.add_argument('--chat_log_path', default="./outputs/webqsp/chat_wo_icl_v1.txt")
    parser.add_argument('--log_path', default=None)
    parser.add_argument('--model_path', default=None)
    parser.add_argument('--debug', action="store_true")
    parser.add_argument('--prompt_path', default="./prompts/prompt_for_webqsp.json")
    parser.add_argument('--prompt_name', default="chat_v1", )
    ...
    parser.add_argument('--ent2id_path', default="./data/webqsp/ent2id.pickle", help='the sparse ent2id file')
    parser.add_argument('--rel2id_path', default="./data/webqsp/rel2id.pickle", help='the sparse rel2id file')
    parser.add_argument('--ent2name_path', default="./data/webqsp/entity_name.pickle", help='the sparse rel2id file')
